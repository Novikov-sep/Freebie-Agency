...
let slider_rate = new Swiper('.slider-rate', {
   //effect: 'fade',
   autoplay: {
      delay: 5000,
      disableOnInteraction: false,
...
function app() {
   ...
   const cards = document.querySelectorAll('.item-works')
...
if (document.querySelector('._touch')) {
   document.querySelectorAll('.card-team__text').forEach(element => {
      element.classList.add('t-mobile');
   });

   document.querySelectorAll('.text-hide').forEach(element => {
